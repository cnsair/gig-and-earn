                                ...
                                <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                                    ...
                                    <div class="w-full md:w-5/6">
                                        ...
                                        <h3 class="text-xl font-semibold text-gray-800 hover:text-blue-600">
                                            ...
                                            @else
                                                <a href="#{{ $job->title }}" class="text-blue-500 hover:underline">
                                                    {{ $job->title }}
                                                </a>
                                            @endif
                                        ...
                                        <div class="mt-3 flex flex-col md:flex-row md:justify-between items-start md:items-center space-y-3 md:space-y-0">
                                            <span class="text-xs text-gray-400 font-bold">
                                                {{ $job->category->category }} | {{ $job->created_at->diffForHumans() }}
                                            </span>
                                            <div class="flex space-x-2">
                                                <a href="{{ route('job.show', ['job' => $job->id]) }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-xs font-semibold rounded-md hover:bg-blue-600">
                                                    Details
                                                </a>
