                ...
                <table class="min-w-full text-sm text-gray-800">
                    <thead class="bg-gray-100 border-b">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left font-bold tracking-wider uppercase">Subject</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <form action="{{ route('guest-message.destroy', ['feedback' => $feedback->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <x-danger-button type="submit" onclick="return confirm('Are you sure you want to permanently delete this message?');">
                                            {{ __('Delete') }}
                                        </x-danger-button>
                                    </form>
                                </td>
